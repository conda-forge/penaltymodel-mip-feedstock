...
Once the `conda-forge` channel has been enabled, `penaltymodel-mip` can be installed with:

```
conda install penaltymodel-mip
```

It is possible to list all of the versions of `penaltymodel-mip` available on your platform with:
